...
<model ref="r:b8ce3415-ae60-4951-9fc8-dc62cd6b1f18(Bean.editor)">
  ...
  <node concept="24kQdi" id="16EXoXrTlzd">
    ...
    <node concept="1QoScp" id="16EXoXrYaY9" role="2wV5jI">
      ...
      <node concept="1QoScp" id="GWhHkkvR0F" role="1QoS34">
        <property role="1QpmdY" value="true" />
        <node concept="pkWqt" id="GWhHkkvR0G" role="3e4ffs">
          <node concept="3clFbS" id="GWhHkkvR0H" role="2VODD2">
            <node concept="3clFbF" id="GWhHkkvR0I" role="3cqZAp">
              <node concept="2OqwBi" id="GWhHkkvR0J" role="3clFbG">
                <node concept="2OqwBi" id="GWhHkkvR0K" role="2Oq$k0">
                  <node concept="pncrf" id="GWhHkkvR0L" role="2Oq$k0" />
                  <node concept="2yIwOk" id="GWhHkkvR0M" role="2OqNvi" />
                </node>
                <node concept="3O6GUB" id="GWhHkkvR0N" role="2OqNvi">
                  <node concept="chp4Y" id="GWhHkkvR0O" role="3QVz_e">
        ...
        <node concept="B$lHz" id="GWhHkkvR0P" role="1QoVPY" />
        <node concept="3F0ifn" id="GWhHkkvR0Q" role="1QoS34">
          <node concept="VPxyj" id="GWhHkkvR0R" role="3F10Kt">
            <property role="VOm3f" value="true" />
          </node>
        </node>
      </node>
