...
- [src/bean.langium](src/bean.langium) -  The grammar definition of your language
- [src/bean-module.ts](src/bean-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/bean-validator.ts](src/bean-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/bean.monarch.ts](src/syntaxes/bean.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/bean.tmLanguage.json](syntaxes/bean.tmLanguage.json) - Textmate based syntax highlighting instructions.
